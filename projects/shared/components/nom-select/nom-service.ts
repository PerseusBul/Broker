...
export interface INomService<I, P extends object> {
  getNomsById(params: GetNomsByIdParams<I> & P, filter: any): Observable<Array<INomVO<I>>>;
  getNomsByTerm(params: GetNomsByTermParams & P, filter: any): Observable<Array<INomVO<I>>>;
}

export class NomServiceWithParams<I, P extends object> implements INomService<I, {}> {
  getNomsById: (params: GetNomsByIdParams<I>, filter: any) => Observable<Array<INomVO<I>>>;
  getNomsByTerm: (params: GetNomsByTermParams, filter: any) => Observable<Array<INomVO<I>>>;
