...
import { UsersService } from 'projects/broker-api/api/users.service';
import { ChangePasswordRequest } from 'projects/broker-api/model/changePasswordRequest';
...
@Component({
  selector: 'br-reset-password-change',
