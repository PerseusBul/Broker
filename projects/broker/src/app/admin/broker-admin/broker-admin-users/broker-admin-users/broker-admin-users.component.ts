...
import { BrokerAdminUsersService } from './broker-admin-users.service';

@Component({
  selector: 'br-broker-admin-users',
  templateUrl: './broker-admin-users.component.html',
  styleUrls: ['./broker-admin-users.component.scss']
})
export class BrokerAdminUsersComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private brokerAdminOfficesService: BrokerAdminUsersService, private fb: FormBuilder) {}
