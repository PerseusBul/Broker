...
export class PaymentTypesService implements INomService<number, {}> {
  protected basePath = '/';
  ...
  /**
   * Get a datasource for payment types
   * Get a datasource for payment types
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getPaymentTypes(observe?: 'body', reportProgress?: boolean): Observable<Array<INomVO<number>>>;
  public getPaymentTypes(
    observe?: 'response',
    reportProgress?: boolean
  ): Observable<HttpResponse<Array<INomVO<number>>>>;
  public getPaymentTypes(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<INomVO<number>>>>;
  public getPaymentTypes(observe: any = 'body', reportProgress: boolean = false): Observable<any> {
    ...
    return this.httpClient.request<Array<INomVO<number>>>('get', `${this.basePath}/paymenttypes`, {
